...
| --- | --- |
| [ai-telemetry-workbench](https://github.com/nerc-images/ai-telemetry-workbench) | An OpenShift AI Image running VSCode for Java and Go development of AI Telemetry and the Prometheus Keycloak Proxy. |
...
| [vscode-go](https://github.com/nerc-images/vscode-go) | An OpenShift AI Image running VSCode for Golang development. |
